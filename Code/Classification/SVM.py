...
data = pd.read_csv("Code/Classification/csv_files/train.csv", low_memory=False)
data.head()

test = pd.read_csv("Code/Classification/csv_files/test.csv", low_memory=False)
test.head()
...
file_name = "Code/Predict_signs/files/SVM"
